<!--
  FORK NOTICE
  ===========
  This repository is a verbatim fork of Gen-Verse/LatentMAS
  (https://github.com/Gen-Verse/LatentMAS, commit 9a9e4d3, Apache-2.0),
  used as the unmodified BASELINE for our research on steering vectors for
  latent-space multi-agent communication. The upstream README is reproduced
  in full below. See NOTICE for full attribution and the list of forked files.
-->

> **Fork notice:** This is a verbatim baseline fork of [Gen-Verse/LatentMAS](https://github.com/Gen-Verse/LatentMAS) (commit `9a9e4d3`, Apache-2.0). It is kept unmodified as the baseline for our steering-vector research. See [`NOTICE`](NOTICE) for attribution. The original LatentMAS README follows.
